...
use crate::modules::packages::{
    NativeBinding, Resolved, Resolver, parse_manifest, walk_up_dirs, dir_of, join_relative,
};
...
use super::{
    ModuleEntry, error_stash, get_val, handles, js_fetch_bytes, manifests, put_val, registry,
};
