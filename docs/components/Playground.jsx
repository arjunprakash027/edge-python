        ...
        <div className="ep-pg my-5">
            ...
            <div className="ep-output mt-3" aria-live="polite">
                <div className="flex items-center justify-between gap-2 rounded-t-md border border-b-0 border-gray-300 bg-gray-100 pl-3 pr-1 py-1 dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <Button variant="outline" onClick={onRunClick} className="text-xs flex items-center px-2.5 py-1.5 gap-1.5 transition hover:border-[hsl(var(--nextra-primary-hue)_var(--nextra-primary-saturation)_var(--nextra-primary-lightness)/0.5)] dark:hover:border-[hsl(var(--nextra-primary-hue)_var(--nextra-primary-saturation)_var(--nextra-primary-lightness)/0.5)] hover:shadow-[inset_0_0_0_1px_hsl(var(--nextra-primary-hue)_var(--nextra-primary-saturation)_var(--nextra-primary-lightness)/0.5)]" disabled={running} title="Run code" aria-label="Run code"><PlayIcon/>Run</Button>
                </div>
                <Pre>
                    <Code>{termBody}</Code>
                </Pre>
